...
export default function AnalysisResult({ result, onInsert, onRerun }: Props) {
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={onInsert}
            className="px-3 py-1.5 flex items-center text-xs bg-emerald-50 text-emerald-700 hover:bg-emerald-100 border border-emerald-200 rounded-md transition-colors font-medium cursor-pointer"
